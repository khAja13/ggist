...
export default async function FormPage({ authType, onSubmit, formSchema }: { authType: string, onSubmit: any, formSchema: any }) {
  return (
    <div className="m-auto w-fit min-h-screen flex items-center">
      <div className="border border-smoke-300 p-12 flex flex-col justify-center m-auto">
          ...
          <CustomForm onSubmit={onSubmit} authType={authType} formSchema={formSchema} />
